...
Built a payments table for 2020 reconstructing every payment transaction per customer, handling recurring billing, prorated upgrades, deferred annual payments, and churn cutoffs.📄 [Chanllenge Payment Questions](./queries/challenge_payment_question.sql)

![Payments Table](screenshots/c_payments_challenge.png)
